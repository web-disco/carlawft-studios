...
exports.createResolvers = (args) => {
    ...
    agilityService: {
      ...
      linkedContent_agilityRates: agility.getLinkedContentList({ type: 'agilityRate', linkedContentFieldName: 'rates'})
    },

    // on the 'agilityGlobalFooter' node type...
    agilityGlobalFooter: {
      // column 1 links
      linkedContent_column1Links: agility.getLinkedContentList({ type: 'agilityLink', linkedContentFieldName: 'column1Links' }),
      // column 2 links
      linkedContent_column2Links: agility.getLinkedContentList({ type: 'agilityLink', linkedContentFieldName: 'column2Links' }),
      // column 3 links
      linkedContent_column3Links: agility.getLinkedContentList({ type: 'agilityLink', linkedContentFieldName: 'column3Links' }),
    }
	}
